...
const About = ({ aboutMe }: AboutProps) => {
  ...
  return (
    <section id="about" className="py-24 transition-colors duration-300" style={{ background: 'var(--bg-base)' }}>
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          {/* VS Code Window */}
          <div className="rounded-xl overflow-hidden shadow-2xl font-mono text-sm md:text-base" style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)' }}>
            {/* Window Header */}
